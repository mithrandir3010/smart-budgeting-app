    ...
    <motion.div key="data" {...panelAnim} className="space-y-3">
      ...
      >
        ...
        <div className="text-left">
          ...
          <p className="text-[11px] text-emerald-600 mt-0.5">Tüm işlemleri dışa aktar</p>
        </div>
      </motion.button>
      ...
      >
        ...
        <div className="text-left">
          ...
          <p className="text-[11px] text-rose-600 mt-0.5">Bu işlem geri alınamaz</p>
        </div>
      </motion.button>
    </motion.div>
  );
...
export default function ProfilePage() {
  ...
  if (pageLoading) {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen bg-[#050507] gap-3">
  ...
  return (
    <div className="min-h-screen bg-[#050507] mesh-bg pb-16">
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-2">
            <BrandMark size={24} />
            <span className="font-bold text-zinc-100 tracking-tight text-base">Smart Budget</span>
          </div>
        </div>
      </motion.header>
      ...
      <div className="max-w-5xl mx-auto px-5 md:px-8 pt-8">
        ...
        <motion.div {...fadeUp(0.05)} className="mb-8">
          <h1 className="text-2xl font-bold text-zinc-100 tracking-tight">Profil Ayarları</h1>
          <p className="text-sm text-zinc-600 mt-1">Hesap bilgilerinizi ve güvenlik ayarlarınızı yönetin</p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[260px_1fr] gap-6 items-start">
          ...
          <motion.div {...fadeUp(0.1)} className="lg:sticky lg:top-24">
            ...
            >
              ...
              <div className="relative inline-flex mb-4">
                ...
                <span className="absolute -bottom-1.5 -right-1.5 w-5 h-5 rounded-full bg-emerald-400 border-2 border-[#050507]" />
              </div>

              <h2 className="text-base font-bold text-zinc-100 truncate">{profile.fullName || '—'}</h2>
                  ...
                  <button
                    ...
                    className={`flex flex-col items-center gap-1 py-2 rounded-xl text-[10px] font-semibold transition-all ${
                      activeTab === id
                        ...
                        : 'bg-white/[0.03] text-zinc-600 border border-white/[0.05] hover:text-zinc-400'
                    }`}
                  >
          ...
          <motion.div {...fadeUp(0.18)}>
            ...
            >
              ...
              <div className="relative flex gap-1 p-1 rounded-xl mb-7 hidden lg:flex" style={{ background: 'rgba(255,255,255,0.04)' }}>
                {TABS.map(({ id, label, icon: Icon }) => (
                  <button
                    ...
                    style={{ color: activeTab === id ? '#e4e4e7' : '#52525b' }}
                  >
                    {activeTab === id && (
                      <motion.div
                        layoutId="activeTab"
